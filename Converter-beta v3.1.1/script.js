...
//     mic_icon.classList.toggle("listening");
// });
...
mic_icon.addEventListener('click', function () {
    ...
    recognition.addEventListener('result', e => {
        ...
        // mic_icon.classList.toggle("listening");  
        // ^^ (with this commented it is still changing the icon of the mic during unmute and mute but the pulsing effect is missing and the mic on first click it shows muted but mic is on in the background.)
